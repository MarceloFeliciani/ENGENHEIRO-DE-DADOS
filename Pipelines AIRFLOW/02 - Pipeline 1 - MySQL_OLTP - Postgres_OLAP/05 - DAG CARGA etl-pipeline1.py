...
path_temp_csv = "/tmp/dataset.csv"  # arquivo temporario
email_failed = "marcelo.feliciani@gmail.com" # receberei um email em caso de falha
...
def _extract():
    ...
    engine_mysql_oltp = sqlalchemy.create_engine('mysql+pymysql://root:airflow@172.17.0.3:3306/employees')
...
def _load():
    ...
    engine_postgresql_olap = sqlalchemy.create_engine('postgres+psycopg2://postgres:airflow@172.17.0.4:5432/employees')
...
email_task = EmailOperator(
    ...
    email_on_failure=True,
    email=email_failed, 
    to='marcelo.feliciani@gmail.com',
